...
def RequestThree(StrokiList, Tables, TableStroki):
    """
    Запрос 3: Все строки и их таблицы , отсортированные по ID строки
    """
    Result = [
        {
            'StringId': Stroka.Id,
...
def Main():
    ...
    print("\n" + "ЗАПРОС 2: Минимальные количества символов в строках таблиц, отсортировано по возрастанию символов в строках")
